...
const Card = ({ title, image, id, price_after, price_before }) => {
	return (
		<Link
			to={`/products/${id}`}
			className="flex cursor-pointer flex-col pb-4 flex-shrink-0 w-[250px] h-[380px] min-h-full px-5 pt-4 bg-white rounded-lg  snap-center transition duration-200  "
		>
